...
(function(module) {
  ...
  Article.numWordsAll = function() {
    console.log('hit numWordsAll')
    return Article.all.map(function(article) {
      // console.log('map each article')
      var words = article.body.split(' ');  //split the article-body into a new array STRIP HTML
      return words.length; // Currently Approximate Get the total number of words in this article
    })
    .reduce(function(a, b) {
